...
export function ChangePaswordForm({
  ...
  return (
    <section className="mx-auto w-full max-w-3xl space-y-2.5 sm:space-y-3">
      <header className="rounded-xl border border-amber-200 bg-gradient-to-br from-amber-50 via-white to-orange-50 p-3 sm:rounded-2xl sm:p-4">
        ...
        <ul className="mt-2 hidden space-y-1 text-xs text-slate-600 md:block">
